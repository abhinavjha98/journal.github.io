							...
							<div class="col-lg-12">
								<form id="register-form" method="post" role="form" >
									...
									<div class="form-group">
										<input type="text" name="first_name" id="first_name" tabindex="1" class="form-control" placeholder="First_name" value="" required >
									</div>
									<div class="form-group">
										<input type="text" name="last_name" id="last_name" tabindex="1" class="form-control" placeholder="Last_name" value="" required >
									</div>
									<div class="form-group">
									...
									<!-- <div class="form-group">
										<select name="register_as" required="RE"> Register as:
